...
" Setup the autocommands that handle the MRUList and other stuff. g
...
" BufExplorerHorizontalSplit g
function! BufExplorerHorizontalSplit()
    let s:splitMode = "sp"
    execute "BufExplorer"
endfunction

" BufExplorerVerticalSplit g
...
call s:Set("g:bufExplorerShowDirectories", 0)           " (Dir's are added by commands like ':e .')
...
if !hasmapto('ToggleBufExplorer') && g:bufExplorerDisableDefaultKeyMapping == 0
    nnoremap <script> <silent> <unique> <Leader>l :ToggleBufExplorer<CR>
endif
...
if !hasmapto('BufExplorerVerticalSplit') && g:bufExplorerDisableDefaultKeyMapping == 0
    nnoremap <script> <silent> <unique> <Leader>; :BufExplorerVerticalSplit<CR>
endif
